  ...
  return (
    <>
      <section className="section-padding container-custom max-w-4xl mx-auto">
        <h1 className="text-4xl font-serif font-bold text-[#1B4D2E] mb-2">Cookie Policy</h1>
        <p className="text-gray-500 mb-8">Last updated: {lastUpdated}</p>

        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">What Are Cookies?</h2>
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">How We Use Cookies</h2>
          <p className="text-gray-700 mb-4">{COMPANY.name} uses cookies for the following purposes:</p>
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Types of Cookies We Use</h2>
          <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Third-Party Services</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Your Cookie Choices</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">GDPR Compliance</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Contact Us</h2>
          <p className="text-gray-700 mb-6">
