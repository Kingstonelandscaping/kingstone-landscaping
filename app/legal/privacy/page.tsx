  ...
  return (
    <>
      <section className="section-padding container-custom max-w-4xl mx-auto">
        <h1 className="text-4xl font-serif font-bold text-[#1B4D2E] mb-2">Privacy Policy</h1>
        <p className="text-gray-500 mb-8">Last updated: {lastUpdated}</p>

        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Introduction</h2>
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Information Collection and Use</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Use of Data</h2>
          <p className="text-gray-700 mb-6">{COMPANY.name} uses the collected data for various purposes:</p>
          <ul className="list-disc pl-6 space-y-2 mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Cookies</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold text-[#1B4D2E] mt-8 mb-4">Your Rights</h2>
          <p className="text-gray-700 mb-6">
